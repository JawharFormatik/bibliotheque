...
################################################################################
## Form generated from reading UI file 'Supprimer_etudiant.ui'
##
...
"")
        ...
        self.frame.setGeometry(QRect(20, 0, 1161, 531))
        self.frame.setFrameShape(QFrame.StyledPanel)
        self.frame.setFrameShadow(QFrame.Raised)
        self.label_2 = QLabel(self.frame)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(100, 20, 271, 16))
        self.Supprimer = QTabWidget(self.frame)
        self.Supprimer.setObjectName(u"Supprimer")
        self.Supprimer.setGeometry(QRect(100, 50, 921, 441))
        self.Etudiant = QWidget()
        self.Etudiant.setObjectName(u"Etudiant")
        self.label = QLabel(self.Etudiant)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(270, 110, 261, 101))
        self.lineEdit = QLineEdit(self.Etudiant)
        self.lineEdit.setObjectName(u"lineEdit")
        self.lineEdit.setGeometry(QRect(560, 150, 161, 31))
        self.pushButton = QPushButton(self.Etudiant)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setGeometry(QRect(460, 270, 93, 28))
        self.Supprimer.addTab(self.Etudiant, "")
        self.Section = QWidget()
        self.Section.setObjectName(u"Section")
        self.label_3 = QLabel(self.Section)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(250, 140, 261, 81))
        self.comboBox = QComboBox(self.Section)
        ...
        self.comboBox.setGeometry(QRect(600, 160, 141, 31))
        self.pushButton_2 = QPushButton(self.Section)
        self.pushButton_2.setObjectName(u"pushButton_2")
        self.pushButton_2.setGeometry(QRect(440, 300, 93, 28))
        self.Supprimer.addTab(self.Section, "")
        self.Niveau = QWidget()
        self.Niveau.setObjectName(u"Niveau")
        self.comboBox_2 = QComboBox(self.Niveau)
        self.comboBox_2.addItem("")
        self.comboBox_2.addItem("")
        self.comboBox_2.addItem("")
        self.comboBox_2.setObjectName(u"comboBox_2")
        self.comboBox_2.setGeometry(QRect(570, 150, 151, 31))
        self.label_4 = QLabel(self.Niveau)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(240, 140, 181, 41))
        self.pushButton_3 = QPushButton(self.Niveau)
        self.pushButton_3.setObjectName(u"pushButton_3")
        self.pushButton_3.setGeometry(QRect(440, 280, 93, 28))
        self.Supprimer.addTab(self.Niveau, "")
        self.SectionEtNiveau = QWidget()
        self.SectionEtNiveau.setObjectName(u"SectionEtNiveau")
        self.comboBox_3 = QComboBox(self.SectionEtNiveau)
        self.comboBox_3.addItem("")
        self.comboBox_3.addItem("")
        self.comboBox_3.addItem("")
        self.comboBox_3.setObjectName(u"comboBox_3")
        self.comboBox_3.setGeometry(QRect(420, 150, 151, 31))
        self.comboBox_4 = QComboBox(self.SectionEtNiveau)
        ...
        self.comboBox_4.setGeometry(QRect(630, 150, 141, 31))
        self.label_5 = QLabel(self.SectionEtNiveau)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(200, 140, 171, 51))
        self.pushButton_4 = QPushButton(self.SectionEtNiveau)
        self.pushButton_4.setObjectName(u"pushButton_4")
        self.pushButton_4.setGeometry(QRect(440, 290, 93, 28))
        self.Supprimer.addTab(self.SectionEtNiveau, "")
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(MainWindow)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 1285, 25))
        ...
        self.menuSupprimer.addAction(self.actionLivre_donnee)
        self.menuSupprimer.addAction(self.actionLivres_d_un_auteur)
        self.menuSupprimer.addAction(self.actionLivres_d_une_annee_donnee)
        ...
        self.menuRecuperation.addAction(self.actionRecuperer_les_donnee)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionContenue_du_dictionnaire_Etudiant.setText(QCoreApplication.translate("MainWindow", u"Afficher les Etudiant", None))
        ...
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Suppression d une Eeleve", None))
        self.label.setText(QCoreApplication.translate("MainWindow", u"Numero d inscription ", None))
        self.pushButton.setText(QCoreApplication.translate("MainWindow", u"Supprimer", None))
        self.Supprimer.setTabText(self.Supprimer.indexOf(self.Etudiant), QCoreApplication.translate("MainWindow", u"Etudiant", None))
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"Supprimer une section", None))
        self.comboBox.setItemText(0, QCoreApplication.translate("MainWindow", u"LI", None))
        self.comboBox.setItemText(1, QCoreApplication.translate("MainWindow", u"CPI", None))
        self.comboBox.setItemText(2, QCoreApplication.translate("MainWindow", u"MA", None))
        self.comboBox.setItemText(3, QCoreApplication.translate("MainWindow", u"TIC", None))
        self.comboBox.setItemText(4, QCoreApplication.translate("MainWindow", u"EEA", None))

        self.pushButton_2.setText(QCoreApplication.translate("MainWindow", u"Supprimer", None))
        self.Supprimer.setTabText(self.Supprimer.indexOf(self.Section), QCoreApplication.translate("MainWindow", u"Section", None))
        self.comboBox_2.setItemText(0, QCoreApplication.translate("MainWindow", u"1ere", None))
        self.comboBox_2.setItemText(1, QCoreApplication.translate("MainWindow", u"2eme", None))
        self.comboBox_2.setItemText(2, QCoreApplication.translate("MainWindow", u"3eme", None))

        self.label_4.setText(QCoreApplication.translate("MainWindow", u"Supprimer un Niveau", None))
        self.pushButton_3.setText(QCoreApplication.translate("MainWindow", u"Supprimer", None))
        self.Supprimer.setTabText(self.Supprimer.indexOf(self.Niveau), QCoreApplication.translate("MainWindow", u"Niveau", None))
        self.comboBox_3.setItemText(0, QCoreApplication.translate("MainWindow", u"1ere", None))
        self.comboBox_3.setItemText(1, QCoreApplication.translate("MainWindow", u"2eme", None))
        self.comboBox_3.setItemText(2, QCoreApplication.translate("MainWindow", u"3eme", None))

        self.comboBox_4.setItemText(0, QCoreApplication.translate("MainWindow", u"LI", None))
        self.comboBox_4.setItemText(1, QCoreApplication.translate("MainWindow", u"CPI", None))
        self.comboBox_4.setItemText(2, QCoreApplication.translate("MainWindow", u"MA", None))
        self.comboBox_4.setItemText(3, QCoreApplication.translate("MainWindow", u"TIC", None))
        self.comboBox_4.setItemText(4, QCoreApplication.translate("MainWindow", u"EEA", None))

        self.label_5.setText(QCoreApplication.translate("MainWindow", u"Niveau /Section", None))
        self.pushButton_4.setText(QCoreApplication.translate("MainWindow", u"Supprimer", None))
        self.Supprimer.setTabText(self.Supprimer.indexOf(self.SectionEtNiveau), QCoreApplication.translate("MainWindow", u"Section Et Niveau", None))
