...
"")
        ...
        self.actionAcceuil = QAction(MainWindow)
        self.actionAcceuil.setObjectName(u"actionAcceuil")
        ...
        self.label.setGeometry(QRect(30, -30, 161, 141))
        self.tableWidget = QTableWidget(self.centralwidget)
        self.tableWidget.setObjectName(u"tableWidget")
        self.tableWidget.setGeometry(QRect(640, 70, 591, 461))
        self.tabWidget = QTabWidget(self.centralwidget)
        self.tabWidget.setObjectName(u"tabWidget")
        self.tabWidget.setGeometry(QRect(10, 70, 621, 461))
        self.tabWidget.setToolTipDuration(0)
        self.tab = QWidget()
        self.tab.setObjectName(u"tab")
        self.label_11 = QLabel(self.tab)
        self.label_11.setObjectName(u"label_11")
        self.label_11.setGeometry(QRect(280, 10, 171, 91))
        self.label_11.setStyleSheet(u"font: 87 12pt \"Verdana Pro Cond Black\";\n"
"color: rgb(0, 170, 127);")
        self.pushButton_2 = QPushButton(self.tab)
        self.pushButton_2.setObjectName(u"pushButton_2")
        self.pushButton_2.setGeometry(QRect(270, 300, 93, 28))
        self.lineEdit_2 = QLineEdit(self.tab)
        self.lineEdit_2.setObjectName(u"lineEdit_2")
        self.lineEdit_2.setGeometry(QRect(390, 200, 161, 31))
        self.label_3 = QLabel(self.tab)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(130, 150, 261, 101))
        self.tabWidget.addTab(self.tab, "")
        self.tab_2 = QWidget()
        self.tab_2.setObjectName(u"tab_2")
        self.label_12 = QLabel(self.tab_2)
        self.label_12.setObjectName(u"label_12")
        self.label_12.setGeometry(QRect(260, 10, 171, 91))
        self.label_12.setStyleSheet(u"font: 87 12pt \"Verdana Pro Cond Black\";\n"
"color: rgb(0, 170, 127);")
        self.label_4 = QLabel(self.tab_2)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(120, 110, 261, 101))
        self.lineEdit_3 = QLineEdit(self.tab_2)
        self.lineEdit_3.setObjectName(u"lineEdit_3")
        self.lineEdit_3.setGeometry(QRect(330, 150, 161, 31))
        self.pushButton_3 = QPushButton(self.tab_2)
        self.pushButton_3.setObjectName(u"pushButton_3")
        self.pushButton_3.setGeometry(QRect(250, 330, 93, 28))
        self.tabWidget.addTab(self.tab_2, "")
        self.tab_3 = QWidget()
        self.tab_3.setObjectName(u"tab_3")
        self.label_13 = QLabel(self.tab_3)
        self.label_13.setObjectName(u"label_13")
        self.label_13.setGeometry(QRect(250, 10, 171, 91))
        self.label_13.setStyleSheet(u"font: 87 12pt \"Verdana Pro Cond Black\";\n"
"color: rgb(0, 170, 127);")
        self.label_6 = QLabel(self.tab_3)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(120, 120, 261, 101))
        self.lineEdit_4 = QLineEdit(self.tab_3)
        self.lineEdit_4.setObjectName(u"lineEdit_4")
        self.lineEdit_4.setGeometry(QRect(370, 170, 161, 31))
        self.pushButton_4 = QPushButton(self.tab_3)
        self.pushButton_4.setObjectName(u"pushButton_4")
        self.pushButton_4.setGeometry(QRect(240, 330, 93, 28))
        self.tabWidget.addTab(self.tab_3, "")
        self.tab_4 = QWidget()
        self.tab_4.setObjectName(u"tab_4")
        self.label_14 = QLabel(self.tab_4)
        self.label_14.setObjectName(u"label_14")
        self.label_14.setGeometry(QRect(250, 10, 171, 91))
        self.label_14.setStyleSheet(u"font: 87 12pt \"Verdana Pro Cond Black\";\n"
"color: rgb(0, 170, 127);")
        self.label_5 = QLabel(self.tab_4)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(90, 120, 261, 101))
        self.lineEdit_5 = QLineEdit(self.tab_4)
        self.lineEdit_5.setObjectName(u"lineEdit_5")
        self.lineEdit_5.setGeometry(QRect(350, 160, 161, 31))
        self.pushButton_5 = QPushButton(self.tab_4)
        self.pushButton_5.setObjectName(u"pushButton_5")
        self.pushButton_5.setGeometry(QRect(230, 330, 93, 28))
        self.tabWidget.addTab(self.tab_4, "")
        self.tab_5 = QWidget()
        self.tab_5.setObjectName(u"tab_5")
        self.label_15 = QLabel(self.tab_5)
        self.label_15.setObjectName(u"label_15")
        self.label_15.setGeometry(QRect(270, 0, 171, 91))
        self.label_15.setStyleSheet(u"font: 87 12pt \"Verdana Pro Cond Black\";\n"
"color: rgb(0, 170, 127);")
        self.label_7 = QLabel(self.tab_5)
        self.label_7.setObjectName(u"label_7")
        self.label_7.setGeometry(QRect(80, 110, 261, 101))
        self.lineEdit_6 = QLineEdit(self.tab_5)
        self.lineEdit_6.setObjectName(u"lineEdit_6")
        self.lineEdit_6.setGeometry(QRect(320, 150, 161, 31))
        self.pushButton_6 = QPushButton(self.tab_5)
        self.pushButton_6.setObjectName(u"pushButton_6")
        self.pushButton_6.setGeometry(QRect(250, 330, 93, 28))
        self.tabWidget.addTab(self.tab_5, "")
        self.tab_7 = QWidget()
        self.tab_7.setObjectName(u"tab_7")
        self.label_10 = QLabel(self.tab_7)
        self.label_10.setObjectName(u"label_10")
        self.label_10.setGeometry(QRect(250, 10, 171, 91))
        self.label_10.setStyleSheet(u"font: 87 12pt \"Verdana Pro Cond Black\";\n"
"color: rgb(0, 170, 127);")
        self.label_2 = QLabel(self.tab_7)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(120, 120, 261, 101))
        self.lineEdit = QLineEdit(self.tab_7)
        self.lineEdit.setObjectName(u"lineEdit")
        self.lineEdit.setGeometry(QRect(370, 160, 161, 31))
        self.pushButton = QPushButton(self.tab_7)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setGeometry(QRect(270, 270, 93, 28))
        self.tabWidget.addTab(self.tab_7, "")
        self.tab_6 = QWidget()
        self.tab_6.setObjectName(u"tab_6")
        self.label_16 = QLabel(self.tab_6)
        self.label_16.setObjectName(u"label_16")
        self.label_16.setGeometry(QRect(260, 0, 171, 91))
        self.label_16.setStyleSheet(u"font: 87 12pt \"Verdana Pro Cond Black\";\n"
"color: rgb(0, 170, 127);")
        self.label_8 = QLabel(self.tab_6)
        self.label_8.setObjectName(u"label_8")
        self.label_8.setGeometry(QRect(90, 90, 261, 101))
        self.lineEdit_7 = QLineEdit(self.tab_6)
        self.lineEdit_7.setObjectName(u"lineEdit_7")
        self.lineEdit_7.setGeometry(QRect(340, 130, 161, 31))
        self.pushButton_7 = QPushButton(self.tab_6)
        self.pushButton_7.setObjectName(u"pushButton_7")
        self.pushButton_7.setGeometry(QRect(250, 290, 93, 28))
        self.tabWidget.addTab(self.tab_6, "")
        self.tab_8 = QWidget()
        self.tab_8.setObjectName(u"tab_8")
        self.label_17 = QLabel(self.tab_8)
        self.label_17.setObjectName(u"label_17")
        self.label_17.setGeometry(QRect(260, 0, 171, 91))
        self.label_17.setStyleSheet(u"font: 87 12pt \"Verdana Pro Cond Black\";\n"
"color: rgb(0, 170, 127);")
        self.label_9 = QLabel(self.tab_8)
        self.label_9.setObjectName(u"label_9")
        self.label_9.setGeometry(QRect(120, 110, 261, 101))
        self.lineEdit_8 = QLineEdit(self.tab_8)
        self.lineEdit_8.setObjectName(u"lineEdit_8")
        self.lineEdit_8.setGeometry(QRect(340, 150, 161, 31))
        self.pushButton_8 = QPushButton(self.tab_8)
        self.pushButton_8.setObjectName(u"pushButton_8")
        self.pushButton_8.setGeometry(QRect(230, 310, 93, 28))
        ...
        self.menuRecherche_et_Affichage_2.addAction(self.actionRecherche_par_annee_edition_donne)
        self.menuRecherche_et_Affichage_2.addAction(self.actionRecherche_et_Affichage_des_livres_par_ordre_alphabetique)
        ...
        self.menuRecherche_Affichage.addAction(self.actionRecherche_emprunt_par_etudiant)
        self.menuRecherche_Affichage.addAction(self.actionRecherche_livres_empruntee_a_une_date_donnee)
        self.menuRecherche_Affichage.addAction(self.actionRecherche_livres_retournee_a_une_date_donne)
        self.menuRecherche_Affichage.addAction(self.actionRecherche_livres_empruntee_entre_2_dates_donnee)
        self.menuRecherche_Affichage.addAction(self.actionRecherche_livres_retournee_entre_2_date_donne)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionContenue_du_dictionnaire_livre.setText(QCoreApplication.translate("MainWindow", u"Contenue du dictionnaire livre", None))
        ...
        self.actionRecherche_emprunt_par_livre.setText(QCoreApplication.translate("MainWindow", u"Recherche emprunt par livre", None))
        ...
        self.actionRecuperation_des_donnee.setText(QCoreApplication.translate("MainWindow", u"Enregistrer Ficher Etudiant", None))
        self.actionAcceuil.setText(QCoreApplication.translate("MainWindow", u"Acceuil", None))
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"Recherhce par :", None))
        self.label_11.setText(QCoreApplication.translate("MainWindow", u"N\u00b0 Inscri", None))
        self.pushButton_2.setText(QCoreApplication.translate("MainWindow", u"Recherche", None))
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"Numero  Inscription", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QCoreApplication.translate("MainWindow", u"N\u00b0 inscri", None))
        self.label_12.setText(QCoreApplication.translate("MainWindow", u"Nom", None))
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"Nom", None))
        self.pushButton_3.setText(QCoreApplication.translate("MainWindow", u"Recherche", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), QCoreApplication.translate("MainWindow", u"Nom", None))
        self.label_13.setText(QCoreApplication.translate("MainWindow", u"Prenom", None))
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"Prenom", None))
        self.pushButton_4.setText(QCoreApplication.translate("MainWindow", u"Recherche", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), QCoreApplication.translate("MainWindow", u"Prenom", None))
        self.label_14.setText(QCoreApplication.translate("MainWindow", u"Section", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"Section", None))
        self.pushButton_5.setText(QCoreApplication.translate("MainWindow", u"Recherche", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), QCoreApplication.translate("MainWindow", u"Section", None))
        self.label_15.setText(QCoreApplication.translate("MainWindow", u"Niveau", None))
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"Niveau", None))
        self.pushButton_6.setText(QCoreApplication.translate("MainWindow", u"Recherche", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_5), QCoreApplication.translate("MainWindow", u"Niveau", None))
        self.label_10.setText(QCoreApplication.translate("MainWindow", u"Telephone", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Numero Telephone", None))
        self.pushButton.setText(QCoreApplication.translate("MainWindow", u"Recherche", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_7), QCoreApplication.translate("MainWindow", u"Tel", None))
        self.label_16.setText(QCoreApplication.translate("MainWindow", u"Mail", None))
        self.label_8.setText(QCoreApplication.translate("MainWindow", u"Mail", None))
        self.pushButton_7.setText(QCoreApplication.translate("MainWindow", u"Recherche", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_6), QCoreApplication.translate("MainWindow", u"Mail", None))
        self.label_17.setText(QCoreApplication.translate("MainWindow", u"Adresse", None))
        self.label_9.setText(QCoreApplication.translate("MainWindow", u"Adresse", None))
        self.pushButton_8.setText(QCoreApplication.translate("MainWindow", u"Recherche", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_8), QCoreApplication.translate("MainWindow", u"adress", None))
